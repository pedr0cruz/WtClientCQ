...
const char *WorkSpaceView::FileSelectionMimeType = "application/x-computers-selection";

// Constructor
WorkSpaceView::WorkSpaceView(Wt::WContainerWidget *parent) : WTreeView(parent)
{
...
void WorkSpaceView::dropEvent(const Wt::WDropEvent& event,	const Wt::WModelIndex& target)
{
	/*
